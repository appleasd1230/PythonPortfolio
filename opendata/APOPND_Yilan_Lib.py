...
Log_path = os.path.join(path,"log","APOPND_Yilan_Library.log")
...
class APOPND_Yilan_Library(): #主要抓的地方
	def __init__(self):
		self.GetCSVurl()
		self.APOPND_Yilan_Library_crawler()

	def GetCSVurl(self):
		url = "https://data.gov.tw/dataset/42294"
	...
	def APOPND_Yilan_Library_crawler(self):
		...
		for url in URL_LIST:
			...
			if(res.status_code == 200):
				Filename = 'APOPND_Yilan_Library.xml' #這裡要改
